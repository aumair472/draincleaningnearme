      ...
      <div className="container relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            <div
              className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-xs font-bold uppercase tracking-widest text-primary animate-fade-in"
            >
              < Zap size={14} className="fill-primary" /> Rapid Response Guaranteed
            </div>
            <h2 className="text-[36px] sm:text-[44px] font-bold tracking-tight text-text leading-tight animate-fade-in [animation-delay:100ms]">
              Fast Help When Drains Fail
            </h2>
            <p className="text-text/80 font-medium leading-relaxed max-w-xl text-lg animate-fade-in [animation-delay:200ms]">
            ...
            <div className="flex flex-wrap gap-4 pt-4 animate-fade-in [animation-delay:300ms]">
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={i}
                className="p-6 rounded-xl bg-card border border-border shadow-sm hover:shadow-md transition-all group animate-fade-in-up"
