        ...
        <section className="p-10 md:p-14 rounded-xl bg-card border border-border shadow-sm  relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-12 relative z-10">
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <h3 className="text-xl font-bold uppercase  tracking-tight text-primary">Everyday Causes</h3>
        ...
        <section className="p-10 md:p-14 rounded-xl bg-card border border-border ">
           ...
           <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <Link key={i} href={service.href} className="p-6 rounded-xl bg-bg border-gray-1000 border border-border hover:border-primary/20 transition-all hover:shadow-md text-center group transition-all">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-text/80 group-hover:text-primary transition-colors ">
                    {service.title} &rarr;
                  </span>
                </Link>
              ))}
