  ...
  return (
    <ServicePageLayout
      ...
      description={
        <>
          <p>
            Stop guessing what is wrong with your plumbing. A professional <span className="text-text font-bold ">drain camera inspection</span> 
    ...
    >
      <div className="space-y-24">
        ...
        <section className="p-10 md:p-14 rounded-xl bg-card border border-border shadow-sm  relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-12 relative z-10">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="p-4 rounded-xl bg-bg border-gray-1000 border border-border group hover:border-primary/20 transition-all hover:shadow-md transition-colors">
                     <h4 className="text-xs font-bold uppercase tracking-widest text-primary mb-1 group-hover:text-text transition-colors">{item.t}</h4>
            ...
            <div className="p-10 rounded-xl bg-primary/5 border border-primary/20 flex flex-col justify-center text-center">
               <h3 className="text-lg font-bold uppercase  text-text mb-4">Precision is Key</h3>
        ...
        {/* Home Buyer Special */}
        <section className="bg-bg rounded-xl p-10 md:p-14 border border-border shadow-sm  flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-2/3 space-y-6">
            ...
            <Link href="tel:+17247506935" className="inline-flex h-12 px-8 bg-primary/10 border border-primary/30 text-primary rounded-xl items-center justify-center font-bold uppercase  text-xs tracking-widest hover:bg-primary/20 transition-colors">
