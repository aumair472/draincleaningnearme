...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://draincleaningnearme.us"),
  openGraph: {
    title: "Drain Cleaning Services Near Me | 24/7 Emergency Plumbers",
  ...
  return (
    <html lang="en" suppressHydrationWarning className="scroll-smooth" data-scroll-behavior="smooth">
      <head>
        ...
        <Script id="google-tag-manager" strategy="afterInteractive">
          {`(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
            ...
            })(window,document,'script','dataLayer','GTM-NCS6ZJ8R');`}
        </Script>
      </head>
      <body
      ...
      >
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-NCS6ZJ8R"
            height="0"
            width="0"
