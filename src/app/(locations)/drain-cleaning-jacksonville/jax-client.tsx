        ...
        <section className="relative flex flex-col justify-center pt-24 pb-12 overflow-hidden bg-bg border-b border-border">
          ...
          <div className="container relative z-10 w-full">
            <div className="flex flex-col items-center text-center container-narrow">
              <TrustBadge 
                badgeText="FL"
                text="Licensed and Insured Jacksonville Plumbers"
              />

              <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight mb-6 uppercase italic text-text leading-[1.1] uppercase font-black animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mb-10 animate-fade-in-up [animation-delay:200ms]">
                ...
                <a
                  href="#estimate"
                  className="flex items-center justify-center gap-3 px-8 py-5 bg-card border-2 border-border text-text rounded-2xl font-bold text-xl hover:border-primary transition-all active:scale-95 uppercase font-black">
                  Get Free Quote
                </a>
              </div>
           ...
           <div className="container">
              <div className="grid lg:grid-cols-2 gap-10 items-center">
                 ...
                 <div className="space-y-6 order-1 lg:order-2">
                    ...
                    <div className="space-y-6">
                       <div className="flex gap-6 p-4 rounded-2xl bg-bg border border-border shadow-sm group hover:border-primary/20 transition-all">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                       {[
                         ...
                         "Multiple backups (main line blockage)"
                          ...
                          <div key={i} className="p-4 rounded-2xl bg-bg border border-border shadow-sm flex items-center gap-4 group hover:border-primary/20 transition-all">
                 ...
                 <div className="space-y-12">
                    ...
                    <div className="space-y-6 text-lg text-text/70 italic font-medium leading-relaxed">
                       ...
                       <div className="grid sm:grid-cols-2 gap-6 pt-6">
                          <div className="p-4 rounded-2xl bg-bg border border-border text-center">
                          ...
                          <div className="p-4 rounded-2xl bg-bg border border-border text-center flex flex-col justify-center">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                       {[
                         ...
                         { t: "San Marco", d: "Modern drain main lines." }
                          ...
                          <div key={i} className="p-4 rounded-2xl bg-bg border border-border shadow-sm group hover:border-primary/20 transition-all">
        ...
        <section className="py-16 md:py-20 bg-card overflow-hidden relative border-y border-border">
           ...
           <div className="container-narrow text-center space-y-8 relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                 ...
                 <a
                    href="#estimate"
                    className="w-full sm:w-auto flex items-center justify-center gap-4 px-10 py-5 bg-card border-2 border-border text-text rounded-2xl font-bold text-xl hover:border-primary transition-all active:scale-95 tracking-tight font-black uppercase">
                    Book Online
                 </a>
              </div>
           </div>
