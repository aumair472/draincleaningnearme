            ...
            <div className="flex flex-col items-center text-center container-narrow">
              ...
              >
                <div className="flex -space-x-1.5">
                   {[1,2,3].map(i => <div key={i} className="w-5 h-5 rounded-full border-2 border-card bg-primary/20 flex items-center justify-center text-[8px] font-bold">DC</div>)}
                </div>
                <span className="text-sm font-semibold text-text/60">
                   Licensed and Insured Washington DC Plumbers
                </span>
              </motion.div>
