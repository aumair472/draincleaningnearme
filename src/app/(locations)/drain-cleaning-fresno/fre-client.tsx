...
const serviceAreas = [
  "Tower District", "Woodward Park", "Sunnyside", "Fig Garden", 
  "Downtown Fresno", "Clovis", "Sanger"
];

const mainTelLink = "tel:+17247506935";

export function FREClient() {
      ...
      <main className="flex-1 pt-20">
            ...
            <div className="flex flex-col items-center text-center container-narrow">
              ...
              >
                <div className="flex -space-x-1.5">
                   {[1,2,3].map(i => <div key={i} className="w-5 h-5 rounded-full border-2 border-card bg-primary/20 flex items-center justify-center text-[8px] font-bold">FRE</div>)}
                </div>
                <span className="text-sm font-semibold text-text/60 font-black">
                   Licensed and Insured Fresno Plumbers
                </span>
              </motion.div>
              ...
              >
                Professional Drain Cleaning & <span className="text-primary italic">Rooter Services</span> in Fresno
              </motion.h1>
              ...
              >
                Clogged drains disrupting your Fresno home? We deliver fast, reliable solutions for specialized plumbing challenges, from Tower District's historic pipes to modern sewer line clearing in Woodward Park.
              </motion.div>
              ...
              >
                 ...
                 <div className="flex items-center gap-2"><Star size={18} className="text-accent fill-accent" /> Fresno Experts</div>
              </motion.div>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text leading-tight uppercase font-black underline decoration-primary decoration-4 underline-offset-8">
                   Fresno's Central Valley Plumbing Challenges
                </h2>
                <div className="text-lg text-text/70 leading-relaxed font-medium space-y-6 italic">
                   <p>
                    Fresno's unique Central Valley climate and agricultural history place specific stress on residential plumbing. From aging iron pipes in the Tower District to heavy silt and mineral buildup, our experts understand the local challenges.
                   </p>
                   <p>
                    The region's mature oak and fruit trees often lead to aggressive root intrusion in older sewer line joints, while high summer temperatures and dust can impact outdoor drainage systems.
                   </p>
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
                   {[
                     { t: "Historic Pipe Decay", d: "Old iron and clay systems prone to collapse.", icon: Activity },
                     { t: "Silt & Mineral Buildup", d: "Valley soil and water cause heavy sediment.", icon: Waves },
                     { t: "Root Intrusion", d: "Mature local roots invade old sewer joints.", icon: Droplets },
              ...
              <div className="relative">
                 <div className="aspect-square bg-bg border border-border rounded-[3rem] p-12 shadow-2xl relative overflow-hidden flex flex-col justify-center items-center text-center">
                    ...
                    <p className="text-sm text-text/50 font-bold max-w-xs leading-relaxed uppercase tracking-widest italic">
                       Delivering 5-star service from Woodward Park to Fig Garden.
                    </p>
                 </div>
              </div>
            </div>
          ...
          <div className="container text-center">
             <div className="mb-20 space-y-4">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text uppercase font-black">
                  Fresno Drain Services
                </h2>
                <p className="text-text/70 font-medium text-lg max-w-2xl mx-auto italic">
                    Fast relief from backups, slow drains and foul odors in Fresno County.
                </p>
             </div>
             ...
             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  { title: "Commercial Drain Solutions", desc: "Heavy-duty grease trap and line cleaning for Fresno's thriving restaurant scene.", icon: Building2 },
        ...
        <section className="py-24 bg-card border-b border-border text-center">
          <div className="container">
             ...
             <p className="text-text/70 font-medium text-lg mb-16 italic">Serving all of Fresno and surrounding areas.</p>
        ...
        <section className="py-24 bg-bg border-b border-border">
           <div className="container-narrow">
              ...
              <div className="space-y-4 font-black uppercase italic">
                {[
                  { q: "How much does drain cleaning cost in Fresno?", a: "Residential drain clearing typically ranges from $150 to $450 depending on the severity and equipment needed. We provide upfront quotes on-site." },
                  { q: "Can old Fresno pipes handle hydro jetting?", a: "Yes, but we always perform an HD camera inspection first to verify the pipe's integrity before applying high pressure." },
                  { q: "Do you offer emergency services in the Tower District?", a: "Absolutely. We offer 24/7 priority response for the Tower District and all surrounding Fresno neighborhoods." },
                  { q: "Why are my drains slow after summer?", a: "Dust and silt buildup during the dry Valley summers can impact flow. Our experts can clear this fast." }
                ].map((faq, index) => (
