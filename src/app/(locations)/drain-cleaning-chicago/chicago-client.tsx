  ...
  return (
    <div className="flex flex-col bg-bg font-body">
      <main className="flex-1">
        ...
        <section className="relative min-h-[80vh] flex flex-col justify-center py-20 overflow-hidden bg-bg border-b border-border">
          ...
          <div className="container relative z-10 w-full">
            <div className="flex flex-col items-center text-center container-narrow">
              <TrustBadge 
                badgeText="CHI"
                text="Licensed and Insured Chicagoland Plumbers"
              />

              <h1
                className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-8 text-text leading-[1.1] animate-fade-in">
                Professional Chicago Drain Cleaning & <span className="text-primary">Rooter Services</span>
              </h1>

              <div
                className="text-lg md:text-xl text-text/70 font-medium max-w-3xl mx-auto mb-12 leading-relaxed animate-fade-in [animation-delay:100ms]">
              ...
              <div
                 className="flex flex-wrap justify-center gap-8 py-6 px-10 bg-card/50 border border-border rounded-full text-sm font-semibold text-text/60 animate-fade-in [animation-delay:300ms]">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                   {[
                     ...
                     { t: "Heavy rainfall", d: "High water pressure causing regional backups." }
                      ...
                      <div key={i} className="flex gap-4 p-4 rounded-xl bg-bg border border-border shadow-sm group hover:border-primary/20 transition-all animate-fade-in-up" style={{ animationDelay: `${i * 50}ms` }}>
        ...
        <section className="py-24 bg-bg border-b border-border">
          <div className="container">
             <div className="text-center mb-20 space-y-4">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text animate-fade-in">
                  Our drain cleaning services in Chicago
                </h2>
                <p className="text-text/70 font-medium text-lg max-w-2xl mx-auto animate-fade-in [animation-delay:100ms]">
             ...
             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  <div
                    key={i}
                    className="p-10 rounded-[2.5rem] bg-card border border-border hover:border-primary/20 transition-all hover:shadow-2xl group flex flex-col items-center text-center shadow-sm animate-fade-in-up"
          ...
          <div className="container">
             <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8 animate-fade-in">
                   ...
                   <div className="grid sm:grid-cols-2 gap-4">
                      {[
                        ...
                        { t: "Recurring clogs", icon: Plus }
                         ...
                         <div key={i} className="flex items-center gap-4 p-5 rounded-2xl bg-bg border border-border shadow-sm group hover:bg-card transition-all animate-fade-in-up" style={{ animationDelay: `${i * 50}ms` }}>
                   ...
                   <div className="p-8 rounded-[2rem] bg-bg border border-border shadow-inner animate-fade-in-up [animation-delay:300ms]">
        ...
        <section className="py-24 bg-bg border-b border-border">
          <div className="container text-center">
             <div className="mb-20 space-y-4">
                ...
                <p className="text-text/70 font-medium text-lg max-w-2xl mx-auto italic animate-fade-in [animation-delay:100ms]">Transparent pricing and local expertise you can rely on.</p>
             </div>
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                {[
                  ...
                  <div key={i} className="p-8 rounded-[2rem] bg-card border border-border shadow-sm flex flex-col items-center text-center space-y-4 group hover:border-primary/20 transition-all animate-fade-in-up" style={{ animationDelay: `${i * 100}ms` }}>
             ...
             <div className="mt-16 text-center animate-fade-in-up [animation-delay:600ms]">
        ...
        <section className="py-24 bg-card border-y border-border">
           <div className="container">
              <div className="text-center mb-20 space-y-4">
                 ...
                 <p className="text-text/70 font-medium text-lg animate-fade-in [animation-delay:100ms]">Fast, efficient, and no guesswork for your peace of mind.</p>
              </div>
              <div className="grid md:grid-cols-5 gap-8">
                 {[
                   ...
                   <div key={i} className="flex flex-col items-center text-center space-y-6 group animate-fade-in-up" style={{ animationDelay: `${i * 100}ms` }}>
        ...
        <section className="py-24 bg-bg border-b border-border">
          <div className="container text-center">
             <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text mb-4 animate-fade-in">
               Drain cleaning services across Chicago
             </h2>
             <p className="text-text/70 font-medium text-lg mb-16 italic animate-fade-in [animation-delay:100ms]">Fast local response across all city neighborhoods.</p>
             <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-4">
               {neighborhoods.map((n, i) => (
                 <div key={n} className="p-6 rounded-2xl bg-card border border-border shadow-sm flex flex-col items-center gap-4 group hover:border-primary/30 transition-all animate-fade-in-up" style={{ animationDelay: `${i * 50}ms` }}>
        ...
        <section className="py-24 bg-card border-b border-border">
           <div className="container-narrow">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-center text-text mb-20 uppercase animate-fade-in">
                Frequently asked questions
              </h2>
              <div className="animate-fade-in-up [animation-delay:200ms]">
                <FAQClient faqs={faqs} cityName="Chicago" />
              </div>
           </div>
        </section>
        ...
        <section className="py-24 bg-bg overflow-hidden relative border-y border-border">
           ...
           <div className="container-narrow text-center space-y-12 relative z-10">
              <h2 className="text-4xl md:text-7xl font-bold tracking-tight text-text leading-tight animate-fade-in">
              ...
              <div className="grid sm:grid-cols-3 gap-6">
                 {[
                   ...
                   <div key={i} className="flex flex-col items-center gap-4 p-8 rounded-3xl bg-card border border-red-600/10 shadow-sm text-center group hover:border-red-600/30 transition-all animate-fade-in-up" style={{ animationDelay: `${i * 100}ms` }}>
              ...
              <p className="text-xl text-text/60 font-medium italic animate-fade-in [animation-delay:400ms]">Act early and save thousands in preventable property restoration costs.</p>
           </div>
        </section>
        ...
        <section className="py-24 bg-card">
           <div className="container-narrow">
              <div
                className="p-12 md:p-20 rounded-[4rem] bg-slate-900 border border-primary/20 text-white text-center shadow-2xl relative overflow-hidden group animate-fade-in-up">
