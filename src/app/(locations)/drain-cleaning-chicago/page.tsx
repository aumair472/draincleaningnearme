    ...
    <ServicePageLayout
      ...
      description={
        <>
          ...
          <p>
            DrainCleaningNearMe provides emergency drain cleaning services for Chicago residents; trusted to unclog pipes fast and prevent backups. Call Now for 24/7 Drain Relief: <span className="font-bold text-text">(724) 750-6935</span>
          </p>
        </>
      }
      features={[
          ...
          <div className="p-10 md:p-14 rounded-xl bg-card border border-border shadow-sm ">
            ...
            <div className="mt-8">
               ...
               <ol className="list-decimal pl-4 space-y-3 text-[11px] font-medium text-text/80 uppercase tracking-widest leading-relaxed">
                  ...
                  <li><strong className="text-text">Treatment:</strong> Snaking for simple blockages or 4000 PSI hydro jetting for the rest.</li>
                  <li><strong className="text-text">Verification:</strong> Ensuring unrestricted flow before we leave the site.</li>
               </ol>
            </div>
          </div>
