      ...
      <main className="flex-1">
        ...
        <section className="py-14 md:py-16 bg-card border-b border-border">
           <div className="container">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 font-black uppercase tracking-widest text-lg">
                 {[
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  <div key={i} className="p-8 rounded-[2rem] bg-card border border-border shadow-sm flex flex-col items-center text-center space-y-4 group hover:border-primary/50 transition-all">
                     ...
                     <h4 className="text-lg font-black uppercase tracking-widest text-lg text-text">{f.t}</h4>
        ...
        <section className="py-24 bg-bg border-b border-border text-center">
          <div className="container">
             ...
             <p className="text-text/70 font-medium text-lg mb-10 italic">We cover Fort Worth and nearby DFW spots for residential & commercial drain services.</p>
