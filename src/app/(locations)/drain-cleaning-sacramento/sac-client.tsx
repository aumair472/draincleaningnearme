...
const serviceAreas = [
  "Midtown", "East Sacramento", "Land Park", "Oak Park", 
  "North Sacramento", "Pocket-Greenhaven", "Natomas"
];

const mainTelLink = "tel:+17247506935";

export function SACClient() {
      ...
      <main className="flex-1 pt-20">
            ...
            <div className="flex flex-col items-center text-center container-narrow">
              ...
              >
                <div className="flex -space-x-1.5">
                   {[1,2,3].map(i => <div key={i} className="w-5 h-5 rounded-full border-2 border-card bg-primary/20 flex items-center justify-center text-[8px] font-bold">SAC</div>)}
                </div>
                <span className="text-sm font-semibold text-text/60 font-black">
                   Licensed and Insured Sacramento Plumbers
                </span>
              </motion.div>
              ...
              >
                Professional Drain Cleaning & <span className="text-primary italic">Rooter Services</span> in Sacramento
              </motion.h1>
              ...
              >
                Clogged drains disrupting your Sacramento home? We deliver fast, reliable solutions for specialized plumbing challenges, from Midtown's historic pipes to modern sewer line clearing in East Sacramento.
              </motion.div>
              ...
              >
                 ...
                 <div className="flex items-center gap-2"><Star size={18} className="text-accent fill-accent" /> Sacramento Experts</div>
              </motion.div>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text leading-tight uppercase font-black underline decoration-primary decoration-4 underline-offset-8">
                   Sacramento's Infrastructure & "City of Trees" Challenges
                </h2>
                <div className="text-lg text-text/70 leading-relaxed font-medium space-y-6 italic">
                   <p>
                    Sacramento's massive tree canopy is world-famous, but it presents a major challenge for local sewer lines. Mature root systems aggressively seek moisture in older clay and iron pipe joints, leading to severe blockages.
                   </p>
                   <p>
                    From Midtown's historic architecture to Land Park's established sewer networks, we handle everything from sagging pipes to high-volume grease buildup in our thriving downtown restaurant scene.
                   </p>
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
                   {[
                     { t: "Aggressive Tree Roots", d: "Mature canopy roots invade old sewer joints.", icon: Activity },
                     { t: "Historic Pipe Decay", d: "Old iron and clay systems prone to collapse.", icon: Droplets },
                     { t: "River Silt & Sediment", d: "Proximity to rivers affects soil and flow.", icon: Waves },
                     { t: "Grease & Sludge", d: "Common buildup in high-density areas.", icon: Utensils }
                   ].map((item, i) => (
              ...
              <div className="relative">
                 <div className="aspect-square bg-bg border border-border rounded-[3rem] p-12 shadow-2xl relative overflow-hidden flex flex-col justify-center items-center text-center">
                    ...
                    <p className="text-sm text-text/50 font-bold max-w-xs leading-relaxed uppercase tracking-widest italic">
                       Delivering 5-star service from Land Park to Natomas.
                    </p>
                 </div>
              </div>
            </div>
          ...
          <div className="container text-center">
             <div className="mb-20 space-y-4">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text uppercase font-black">
                  Sacramento Drain Services
                </h2>
                <p className="text-text/70 font-medium text-lg max-w-2xl mx-auto italic">
                    Fast relief from backups, slow drains and foul odors in Sacramento County.
                </p>
             </div>
             ...
             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  { title: "Commercial Drain Solutions", desc: "Heavy-duty grease trap and line cleaning for Sacramento's downtown restaurants.", icon: Building2 },
                  ...
                  { title: "Sewer Line Cleaning", desc: "Restoring flow to main lines without damaging your property.", icon: Droplets },
        ...
        <section className="py-24 bg-card border-b border-border text-center">
          <div className="container">
             ...
             <p className="text-text/70 font-medium text-lg mb-16 italic">Serving all of Sacramento and surrounding areas.</p>
        ...
        <section className="py-24 bg-bg border-b border-border">
           <div className="container-narrow">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-center text-text mb-20 uppercase font-black uppercase italic underline decoration-primary decoration-4 underline-offset-8">
                Sacramento Drain FAQs
              </h2>
              <div className="space-y-4 font-black uppercase italic">
                {[
                  { q: "How much does drain cleaning cost in Sacramento?", a: "Residential drain clearing typically ranges from $150 to $450 depending on the severity and equipment needed. We provide upfront quotes on-site." },
                  { q: "Can old Sacramento pipes handle hydro jetting?", a: "Yes, but we always perform an HD camera inspection first to verify the pipe's integrity before applying high pressure." },
                  { q: "Do you offer emergency services in Land Park?", a: "Absolutely. We offer 24/7 priority response for Land Park and all surrounding Sacramento neighborhoods." },
                  { q: "Why are my drains slow if I have many trees?", a: "Sacramento's 'City of Trees' means massive root systems often invade sewer lines looking for moisture. We can clear these effectively." }
                ].map((faq, index) => (
