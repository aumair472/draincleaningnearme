...
const serviceAreas = [
  "Midtown", "East Memphis", "Downtown", "Harbor Town", 
  "Cooper-Young", "Whitehaven", "Cordova"
];

const mainTelLink = "tel:+17247506935";

export function MemphisClient() {
      ...
      <main className="flex-1">
        ...
        <section className="relative flex flex-col justify-center pt-24 pb-12 overflow-hidden bg-bg border-b border-border">
          ...
          <div className="container relative z-10 w-full">
            <div className="flex flex-col items-center text-center container-narrow">
              <TrustBadge 
                badgeText="MEM"
                text="Licensed and Insured Memphis Plumbers"
              />
              ...
              <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight mb-6 uppercase italic text-text leading-[1.1] animate-fade-in">
                Professional Drain Cleaning & <span className="text-primary italic font-black">Rooter Services</span> in Memphis
              </h1>
              ...
              <div className="text-base md:text-lg text-text/70 font-medium max-w-3xl mx-auto mb-8 italic leading-relaxed animate-fade-in [animation-delay:100ms]">
                Clogged drains causing issues in the Bluff City? We deliver fast, reliable services Memphis residents trust for hydro jetting, sewer cleaning and emergency fixes.
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-6 py-4 px-8 bg-card/50 border border-border rounded-full text-sm font-semibold text-text/60 animate-fade-in [animation-delay:300ms]">
                 ...
                 <div className="flex items-center gap-2"><Star size={18} className="text-accent fill-accent" /> Memphis Experts</div>
              </div>
            </div>
          </div>
        </section>

        {/* 2. WHY MEMPHIS NEEDS EXPERT HELP (LOCAL AUTHORITY) */}
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text leading-tight">
                   Why Memphis Homes Need Expert Drain Cleaning
                </h2>
                <div className="text-lg text-text/70 leading-relaxed font-medium space-y-6">
                   <p>
                    Memphis sits on a mix of heavy clay and limestone soil that places significant stress on underground plumbing. Shifting soil can cause buried pipes to misalign or crack, especially in historic neighborhoods with mature canopies like Midtown and East Memphis. 
                   </p>
                   <p>
                    These established areas are also prone to severe tree root intrusion, where roots aggressively seek moisture in aging clay or cast-iron sewer line joints. Additionally, heavy seasonal storms often overwhelm residential drainage systems, making functional sump pumps and clear main lines essential for home protection.
                   </p>
                </div>
                <div className="p-8 rounded-[2rem] bg-bg border border-border shadow-inner relative overflow-hidden group">
                   <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:scale-110 transition-transform"><Wind size={60} /></div>
                   <h3 className="text-xl font-bold text-text mb-4 tracking-tight uppercase">Delta Soil Specialization</h3>
                   <p className="text-sm text-text/50 italic leading-relaxed">
                      "We specialize in handling the unique soil shift and root intrusion challenges that threaten original plumbing systems in Memphis's historic neighborhood blocks."
                   </p>
                </div>
              </div>
              <div className="relative">
                 <div className="aspect-square bg-bg border border-border rounded-[3.5rem] p-8 md:p-10 shadow-2xl relative overflow-hidden flex flex-col justify-center items-center text-center">
                    ...
                    <h3 className="text-2xl font-bold text-text mb-4 tracking-tight">Bluff City Plumbing Experts</h3>
                    <p className="text-sm text-text/50 font-semibold max-w-xs leading-relaxed uppercase tracking-widest">
                       Specialists in clay soil shifts and delta-driven tree root removal.
                    </p>
                    <div className="mt-8">
                       <p className="text-xs font-bold text-primary uppercase tracking-widest bg-primary/5 px-4 py-2 rounded-full border border-primary/20">
                          Resilient Drainage for Memphis Storms
                       </p>
                    </div>
                 </div>
              </div>
          ...
          <div className="container">
             <div className="text-center mb-12 space-y-3">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text">
                  Our Drain Cleaning Services in Memphis
                </h2>
                <p className="text-text/70 font-medium text-lg max-w-2xl mx-auto italic">
                    Comprehensive solutions customized to Memphis local needs. From snaking to high-pressure jetting.
                </p>
             </div>

             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { title: "Rooter Services Memphis", desc: "Mechanical snaking to break up hair and food clogs in Midtown kitchen and bathroom drains.", icon: Hammer },
                  { title: "Hydro Jetting Services", desc: "Eco-friendly, chemical-free 4,000 PSI water blasting to clear grease and roots from delta sewer lines.", icon: Waves },
                  { title: "Sewer Line Cleaning", desc: "High-level cleaning to remove aggressive tree roots common in East Memphis neighborhoods.", icon: Droplets },
                  { title: "Emergency Drain Service", desc: "24/7 rapid response for backups, arriving within 60 minutes across the Memphis metro area.", icon: Zap },
                  { title: "HD Camera Inspection", desc: "Revealing hidden pipe corrosion or ground movement damage in Downtown and Harbor Town homes.", icon: Search },
                  { title: "Sump Pump Maintenance", desc: "Ensuring your property's basement and crawl space drainage is ready for seasonal storms.", icon: Building2 }
                ].map((s, i) => (
           ...
           <div className="container">
              <div className="text-center mb-12 space-y-3">
                 <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text leading-tight max-w-4xl mx-auto uppercase">
                    Common Drain Problems in Memphis
                 </h2>
                 <p className="text-lg text-text/70 font-medium max-w-3xl mx-auto italic">
                    Memphis's delta geography and soil conditions create unique plumbing headaches.
                 </p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                 {[
                   { t: "Tree Root Intrusion", d: "Mature canopies in residential blocks aggressively seek moisture in aging sewer line joints.", icon: Activity },
                   { t: "Delta Clay Soil Shift", d: "Highly expansive soil moves the ground, causing subterranean sewer line misalignments.", icon: Utensils },
                   { t: "Sump Pump Failure", d: "Heavy seasonal rains can overwhelm systems if crawl space or basement pumps aren't maintained.", icon: Droplets },
                   { t: "Aging Infrastructure", d: "Homes built pre-1970 often face significant corrosion of original cast-iron or clay lines.", icon: Building2 },
                   { t: "Storm System Overload", d: "Lush foliage and debris often clog exterior drains, exacerbating home backup risks during storms.", icon: Waves }
                 ].map((item, i) => (
                 ...
                 <div className="p-8 rounded-[2rem] bg-slate-900 border border-border flex flex-col justify-center items-center text-center space-y-4 text-white">
                    ...
                    <h3 className="text-xl font-bold tracking-tight">Protect Your Home!</h3>
                    <p className="text-xs text-white/40 font-bold uppercase tracking-widest leading-relaxed">
                       Unchecked sewer backups in Memphis can lead to massive structural and mold damage.
                    </p>
                 </div>
              </div>
           </div>
        ...
        <section className="py-14 md:py-16 bg-bg border-b border-border">
           <div className="container-narrow text-center space-y-16">
              ...
              <p className="text-lg text-text/70 font-medium italic">Do not ignore early warnings; acting fast saves thousands on drain repair in Memphis:</p>
              <div className="grid sm:grid-cols-2 gap-4 text-left">
                 {[
                   "Slow drains throughout the entire Bluff City home",
                   ...
                   "Water backing up into tubs when flushing the toilet"
                 ].map((sign, i) => (
        ...
        <section className="py-24 bg-card border-y border-border">
           <div className="container">
              <div className="text-center mb-12 space-y-3">
                 ...
                 <p className="text-text/70 font-medium text-lg max-w-2xl mx-auto italic">Transparent, efficient service for Memphis homes.</p>
              </div>
              <div className="grid md:grid-cols-5 gap-8">
                 {[
                   { t: "Inspection", d: "High-resolution camera scope for buried line issues.", icon: Search },
                   { t: "Diagnosis", d: "Pinpoint cause: debris, roots, or ground shift damage.", icon: Activity },
          ...
          <div className="container text-center">
             ...
             <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {[
                  ...
                  { t: "Upfront Memphis Pricing", icon: Search },
             ...
             <p className="mt-12 text-sm text-text/60 font-medium italic">5-star service from Midtown to East Memphis.</p>
          </div>
        </section>

        {/* 8. PREVENTION TIPS (MEMPHIS DATA) */}
        <section className="py-14 md:py-16 bg-card border-b border-border">
           <div className="container-narrow space-y-16 text-center">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text leading-tight">
                Prevention Tips for Memphis Drains
              </h2>
              <p className="text-lg text-text/70 font-medium italic max-w-2xl mx-auto">Maintain your delta property with these simple tips:</p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                 {[
                   { t: "Maintain Sump Pumps", icon: Trash2 },
        ...
        <section className="py-14 md:py-16 bg-bg border-b border-border">
          <div className="container text-center">
             ...
             <p className="text-text/70 font-medium text-lg mb-10 italic">Covering all Memphis neighborhoods with localized delta plumbing expertise.</p>
        ...
        <section className="py-14 md:py-16 bg-card border-b border-border">
           <div className="container-narrow">
              ...
              <div className="space-y-4">
                {[
                  { q: "How much does professional drain cleaning cost in Memphis?", a: "Residential drain unclogging in Memphis typically ranges between $150-$350. Sump pump maintenance or main line clearing varies, which is why we provide free upfront estimates." },
                  { q: "What is the most common cause of sewer clogs in Midtown?", a: "Most backups in established Memphis neighborhoods are caused by mature tree root intrusion into aging clay or cast-iron sewer lines joints." },
                  { q: "Is hydro jetting safe for historic Cooper-Young homes?", a: "Yes. When performed by our trained professionals, hydro jetting is the safest and most effective way to clear clay and cast-iron lines of decades of debris." },
                  { q: "Why should I have my sump pump checked annually?", a: "Memphis storms can be intense. An annual check ensures your sump pump is ready to prevent basement flooding when heavy rains hit." },
                  { q: "Do you offer emergency rooter services in East Memphis?", a: "Yes, we are Memphis's 24/7 emergency response team, available for all drain and sewer line disasters city-wide." }
                ].map((faq, index) => (
        ...
        <section className="py-24 bg-bg overflow-hidden relative border-y border-border">
           ...
           <div className="container-narrow text-center space-y-8 relative z-10">
              ...
              <p className="text-xl text-text/60 font-medium max-w-2xl mx-auto italic">
                 Licensed professionals ready 24/7. Same-day drain cleaning across Memphis.
              </p>
              ...
              <p className="text-xs font-bold text-text/30 tracking-widest uppercase">
                 Local Memphis Drain Experts &middot; Licensed, Insured, Guaranteed.
              </p>
           </div>
        </section>
