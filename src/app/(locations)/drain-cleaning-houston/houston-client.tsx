                ...
                <div className="grid sm:grid-cols-2 gap-6">
                   {[
                     ...
                     { t: "Aging infrastructure", d: "Older pipes in Harris County require careful HD camera diagnostics." }
                      ...
                      <div key={i} className="flex gap-4 p-4 rounded-2xl bg-bg border border-border shadow-sm group hover:bg-card hover:border-primary/20 transition-all">
          ...
          <div className="container">
             ...
             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={i} className="p-8 rounded-[2rem] bg-bg border border-border hover:border-primary/20 transition-all hover:shadow-2xl group flex flex-col items-center text-center shadow-sm animate-fade-in-up" style={{ animationDelay: `${i * 100}ms` }}>
        ...
        <section className="py-14 md:py-16 bg-bg border-b border-border">
          <div className="container">
             <div className="grid lg:grid-cols-2 gap-10 items-center">
                   ...
                   <div className="grid sm:grid-cols-2 gap-4">
                      {[
                        ...
                        { t: "Aging pipes & soil", d: "Internal structural stress.", icon: Trash2 }
                         ...
                         <div key={i} className="flex flex-col gap-4 p-4 rounded-2xl bg-card border border-border group hover:border-primary/20 transition-all">
                ...
                <div className="relative">
                   <div className="p-12 rounded-[3.5rem] bg-slate-900 border border-primary/20 text-white shadow-2xl space-y-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-left">
                 {[
                   ...
                   "Keep deep-root trees away from main sewer lines"
                    ...
                    <div key={i} className="flex items-start gap-4 p-4 rounded-2xl bg-bg border border-border shadow-sm">
              ...
              <div className="p-12 md:p-20 rounded-[4rem] bg-slate-900 border border-primary/20 text-white text-center shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10 space-y-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                       ...
                       <a
                          href={mainTelLink}
                          className="w-full sm:w-auto flex items-center justify-center gap-4 px-10 py-5 bg-white/10 text-white border-2 border-white/20 rounded-2xl font-bold text-2xl hover:bg-white hover:text-slate-900 transition-all active:scale-95 tracking-tight">
                          Book Service Online
                       </a>
                    </div>
                  </div>
