      ...
      <main className="flex-1">
        ...
        <section className="relative flex flex-col justify-center pt-24 pb-12 overflow-hidden bg-bg border-b border-border">
          ...
          <div className="container relative z-10 w-full">
            <div className="flex flex-col items-center text-center container-narrow">
              <TrustBadge 
                badgeText="ATX"
                text="Licensed and Insured Austin Plumbers"
              />
                ...
                <div className="space-y-4">
                   {[
                     ...
                     { t: "Clay Soil Movement", d: "Soil shifts stress pipes causing cracks and misalignments.", icon: ThermometerSun }
                      ...
                      <div key={i} className="flex gap-4 p-4 rounded-2xl bg-card border border-border shadow-sm group">
          ...
          <div className="container text-center">
             ...
             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={i} className="p-8 rounded-[2rem] bg-bg border border-border hover:border-primary/20 transition-all group flex flex-col items-center text-center shadow-sm animate-fade-in-up" style={{ animationDelay: `${i * 100}ms` }}>
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-left">
                 {[
                   ...
                   "Severe Water Backups into tubs or toilets"
                    ...
                    <div key={i} className="flex items-center gap-4 p-4 rounded-2xl bg-card border border-border shadow-sm group hover:border-primary/20 transition-all">
        ...
        <section className="py-14 md:py-16 bg-bg border-b border-border">
          <div className="container text-center">
             ...
             <p className="text-text/70 font-medium text-lg mb-10 italic">Quick response across Travis and Williamson counties.</p>
             <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
               {serviceAreas.map(n => (
                 <div key={n} className="p-4 rounded-2xl bg-card border border-border shadow-sm flex flex-col items-center gap-4 group hover:border-primary/50 transition-all cursor-default">
