      ...
      <main className="flex-1">
        ...
        <section className="relative flex flex-col justify-center pt-24 pb-12 overflow-hidden bg-bg border-b border-border">
          ...
          <div className="container relative z-10 w-full">
            <div className="flex flex-col items-center text-center container-narrow">
              <TrustBadge 
                badgeText="TX"
                text="Licensed and Insured San Antonio Plumbers"
              />
              ...
              <div className="space-y-6">
                ...
                <div className="text-lg text-text/70 leading-relaxed font-medium space-y-6">
                   ...
                   <ul className="space-y-4">
                      <li className="flex gap-4 p-4 rounded-2xl bg-bg border border-border group hover:border-primary/20 transition-all">
        ...
        <section className="py-14 md:py-16 bg-card border-b border-border">
          <div className="container text-center">
             ...
             <p className="text-text/70 font-medium text-lg mb-10 italic">Drain unclogging near me across San Antonio metro.</p>
