...
const serviceAreas = [
  "The Gulch", "East Nashville", "Germantown", "Sylvan Park", 
  "12 South", "Belle Meade", "Green Hills"
];

const mainTelLink = "tel:+17247506935";

export function NashvilleClient() {
  ...
  return (
    <div className="flex flex-col bg-bg font-body">
      ...
      <main className="flex-1">
        ...
        {/* 1. HERO SECTION (NASHVILLE LOCAL) */}
        <section className="relative flex flex-col justify-center pt-24 pb-12 overflow-hidden bg-bg border-b border-border">
          ...
          <div className="container relative z-10 w-full">
            <div className="flex flex-col items-center text-center container-narrow">
              <TrustBadge 
                badgeText="BNA"
                text="Licensed and Insured Nashville Plumbers"
              />
              ...
              <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight mb-6 uppercase italic text-text leading-[1.1] animate-fade-in">
                Professional Drain Cleaning & <span className="text-primary italic font-black">Rooter Services</span> in Nashville
              </h1>
              ...
              <div className="text-base md:text-lg text-text/70 font-medium max-w-3xl mx-auto mb-8 italic leading-relaxed animate-fade-in [animation-delay:100ms]">
                Clogged drains causing issues in Music City? We deliver fast, reliable services Nashville residents trust for hydro jetting, sewer cleaning and emergency fixes.
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-6 py-4 px-8 bg-card/50 border border-border rounded-full text-sm font-semibold text-text/60 animate-fade-in [animation-delay:300ms]">
                 ...
                 <div className="flex items-center gap-2"><Star size={18} className="text-accent fill-accent" /> Nashville Experts</div>
              </div>
            </div>
          </div>
        </section>

        {/* 2. WHY NASHVILLE NEEDS EXPERT HELP (LOCAL AUTHORITY) */}
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text leading-tight">
                   Why Nashville Homes Need Expert Drain Cleaning
                </h2>
                <div className="text-lg text-text/70 leading-relaxed font-medium space-y-6">
                   <p>
                    Nashville's rapid growth and unique geology create specific plumbing challenges. The region's heavy clay soil is known for significant movement, which can cause subterranean pipes to shift, crack, or misalign—eventually leading to catastrophic foundation leaks and sewer backups.
                   </p>
                   <p>
                    Additionally, many Nashville neighborhoods face high water pressure that stresses older plumbing joints, while our natural hard water leads to significant mineral scale buildup. In established areas like East Nashville and 12 South, mature tree roots aggressively seek out moisture in original clay or cast-iron lines.
                   </p>
                </div>
                <div className="p-8 rounded-[2rem] bg-bg border border-border shadow-inner relative overflow-hidden group">
                   <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:scale-110 transition-transform"><Music size={60} /></div>
                   <h3 className="text-xl font-bold text-text mb-4 tracking-tight uppercase">Middle Tennessee Specialization</h3>
                   <p className="text-sm text-text/50 italic leading-relaxed">
                      "We specialize in resolving the clay-soil shifts and high-pressure stresses that are common causes of drain failure in Nashville's residential infrastructure."
                   </p>
                </div>
              </div>
              <div className="relative">
                 <div className="aspect-square bg-bg border border-border rounded-[3.5rem] p-8 md:p-10 shadow-2xl relative overflow-hidden flex flex-col justify-center items-center text-center">
                    ...
                    <h3 className="text-2xl font-bold text-text mb-4 tracking-tight">Music City Plumbing Experts</h3>
                    <p className="text-sm text-text/50 font-semibold max-w-xs leading-relaxed uppercase tracking-widest">
                       Specialists in clay soil shifts and Tennessee hard water descaling.
                    </p>
                    <div className="mt-8">
                       <p className="text-xs font-bold text-primary uppercase tracking-widest bg-primary/5 px-4 py-2 rounded-full border border-primary/20">
                          Resilient Plumbing for Nashville Growth
                       </p>
                    </div>
                 </div>
              </div>
          ...
          <div className="container">
             <div className="text-center mb-12 space-y-3">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text">
                  Our Drain Cleaning Services in Nashville
                </h2>
                <p className="text-text/70 font-medium text-lg max-w-2xl mx-auto italic">
                    Comprehensive solutions customized to Nashville local needs. From snaking to high-pressure jetting.
                </p>
             </div>

             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { title: "Rooter Services Nashville", desc: "Mechanical snaking to break up hair and food clogs in East Nashville kitchen and bathroom drains.", icon: Hammer },
                  { title: "Hydro Jetting Services", desc: "4,000 PSI deep pipe cleaning to remove decade-old scale and roots without damaging your home's foundation.", icon: Waves },
                  { title: "Sewer Line Cleaning", desc: "Tackling tree root intrusion common in established neighborhoods like Sylvan Park and 12 South.", icon: Droplets },
                  { title: "Emergency Drain Service", desc: "24/7 rapid response for sudden backups, arriving within 60 minutes throughout the Nashville metro.", icon: Zap },
                  { title: "HD Camera Inspection", desc: "Pinpointing clay soil shifts or depth-related pipe damage in Green Hills and Belle Meade properties.", icon: Search },
                  { title: "Pipe Descaling", desc: "Specialized treatment to remove heavy mineral scale caused by Middle Tennessee's hard water.", icon: Building2 }
                ].map((s, i) => (
                  <div key={i} className="p-8 rounded-[2rem] bg-card border border-border hover:border-primary/20 transition-all hover:shadow-2xl group flex flex-col items-center text-center shadow-sm animate-fade-in-up" style={{ animationDelay: `${i * 100}ms` }}>
           ...
           <div className="container">
              <div className="text-center mb-12 space-y-3">
                 <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text leading-tight max-w-4xl mx-auto uppercase">
                    Common Drain Problems in Nashville
                 </h2>
                 <p className="text-lg text-text/70 font-medium max-w-3xl mx-auto italic">
                    Nashville's clay soil and water pressure conditions create unique plumbing headaches.
                 </p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                 {[
                   { t: "Clay Soil Movement", d: "Highly expansive soil shifts buried pipes, causing subterranean sewer line misalignments and cracks.", icon: Activity },
                   { t: "Hard Water Mineral Scale", d: "Tennessee's mineral-rich water narrows your home's pipes over time, causing frequent slow drains.", icon: Utensils },
                   { t: "Tree Root Intrusion", d: "Aggressive roots in historic neighborhood blocks seek moisture in original clay or cast-iron lines.", icon: Droplets },
                   { t: "High Pressure Stress", d: "Nashville's variable water pressure can weaken and blow out aging pipe joints and connections.", icon: Building2 },
                   { t: "Aging Infrastructure", d: "Homes built pre-1980 often face significant corrosion of original plumbing, catching debris easily.", icon: Waves }
                 ].map((item, i) => (
                 ...
                 <div className="p-8 rounded-[2rem] bg-slate-900 border border-border flex flex-col justify-center items-center text-center space-y-4 text-white">
                    ...
                    <h3 className="text-xl font-bold tracking-tight">Prevent Sewer Backups!</h3>
                    <p className="text-xs text-white/40 font-bold uppercase tracking-widest leading-relaxed">
                       Nashville's soil shifts make sewer line failures a common cause of home basement flooding.
                    </p>
                 </div>
              </div>
           </div>
        ...
        <section className="py-14 md:py-16 bg-bg border-b border-border">
           <div className="container-narrow text-center space-y-16">
              ...
              <p className="text-lg text-text/70 font-medium italic">Do not ignore early warnings; acting fast saves thousands on drain repair in Nashville:</p>
              <div className="grid sm:grid-cols-2 gap-4 text-left">
                 {[
                   ...
                   "Water pooling around your home's foundation"
                    ...
                    <div key={i} className="flex items-center gap-4 p-4 rounded-2xl bg-card border border-border shadow-sm group hover:border-primary/30 transition-all font-bold text-text tracking-tight uppercase leading-tight text-sm">
        ...
        <section className="py-24 bg-card border-y border-border">
           <div className="container">
              <div className="text-center mb-12 space-y-3">
                 ...
                 <p className="text-text/70 font-medium text-lg max-w-2xl mx-auto italic">Transparent, efficient service for Nashville homes.</p>
              </div>
              <div className="grid md:grid-cols-5 gap-8">
                 {[
                   { t: "Inspection", d: "Camera scope to find soil shift damage or root entry.", icon: Search },
                   { t: "Diagnosis", d: "Pinpoint cause: debris, roots, or soil misalignment.", icon: Activity },
                   { t: "Method selection", d: "Snaking for minor; hydro jetting for Denver-scale mineral buildup.", icon: Hammer },
                   { t: "Execution", d: "Non-invasive, thorough cleaning of full drainage and sewer lines.", icon: CheckCircle2 },
                   { t: "Final testing", d: "Follow-up camera check to ensure 100% flow capacity restoration.", icon: Waves }
                 ].map((s, i) => (
          ...
          <div className="container text-center">
             ...
             <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {[
                  ...
                  { t: "Upfront Nashville Pricing", icon: Search },
             ...
             <p className="mt-12 text-sm text-text/60 font-medium italic">5-star service from Green Hills to East Nashville.</p>
          </div>
        </section>

        {/* 8. PREVENTION TIPS (NASHVILLE DATA) */}
        <section className="py-14 md:py-16 bg-card border-b border-border">
           <div className="container-narrow space-y-16 text-center">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text leading-tight">
                Prevention Tips for Nashville Drains
              </h2>
              <p className="text-lg text-text/70 font-medium italic max-w-2xl mx-auto">Protect your Middle Tennessee property with these simple tips:</p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                 {[
                   { t: "Monitor water pressure", icon: Trash2 },
                   { t: "Install water softener", icon: Hammer },
                   { t: "Annual inspections", icon: Search },
                   { t: "Check for foundation shifts", icon: ShieldAlert }
                 ].map((tip, i) => (
        ...
        <section className="py-14 md:py-16 bg-bg border-b border-border">
          <div className="container text-center">
             ...
             <p className="text-text/70 font-medium text-lg mb-10 italic">Covering all Nashville neighborhoods with localized Tennessee plumbing expertise.</p>
             <div className="grid grid-cols-2 lg:grid-cols-7 gap-4">
               {serviceAreas.map(n => (
                 <div key={n} className="p-4 rounded-2xl bg-card border border-border shadow-sm flex flex-col items-center gap-4 group hover:border-primary/50 transition-all">
        ...
        <section className="py-14 md:py-16 bg-card border-b border-border">
           <div className="container-narrow">
              ...
              <div className="space-y-4">
                {[
                  { q: "How much does professional drain cleaning cost in Nashville?", a: "Residential drain unclogging in Nashville typically ranges between $150-$350. Major main line descaling or root removal varies, which is why we provide free upfront estimates." },
                  { q: "Why is water pressure such an issue for Nashville plumbing?", a: "Variable water pressure in some Nashville areas stresses pipe joints. Over time, this stress can lead to sudden bursts or subterranean leaks if not managed." },
                  { q: "Is hydro jetting safe for older Sylvan Park homes?", a: "Yes. When performed by our trained professionals after a camera inspection, hydro jetting is the safest way to clear original clay and cast-iron lines of decades of debris." },
                  { q: "How often should Nashville homeowners have drains cleaned?", a: "Due to our regional hard water and expansive clay soil, we recommend professional inspection and cleaning every 12 to 18 months to prevent sudden failures." },
                  { q: "Do you offer emergency rooter services in Germantown?", a: "Yes, we are Nashville's 24/7 emergency response team, available for all drain and sewer line disasters city-wide." }
                ].map((faq, index) => (
        ...
        {/* 11. FINAL CTA / URGENCY (NASHVILLE) */}
        <section className="py-24 bg-bg overflow-hidden relative border-y border-border">
           ...
           <div className="container-narrow text-center space-y-8 relative z-10">
              ...
              <p className="text-xl text-text/60 font-medium max-w-2xl mx-auto italic">
                 Licensed professionals ready 24/7. Same-day drain cleaning across Nashville.
              </p>
              ...
              <p className="text-xs font-bold text-text/30 tracking-widest uppercase">
                 Local Nashville Drain Experts &middot; Licensed, Insured, Guaranteed.
              </p>
           </div>
        </section>
