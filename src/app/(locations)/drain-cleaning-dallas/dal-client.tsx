      ...
      <main className="flex-1">
        ...
        <section className="py-14 md:py-16 bg-bg border-b border-border">
          <div className="container text-center">
             ...
             <p className="text-text/70 font-medium text-lg mb-10 italic">Covering all Dallas neighborhoods with specialized local know-how.</p>
             <div className="grid grid-cols-2 lg:grid-cols-6 gap-4">
               ...
               <div className="p-4 rounded-2xl bg-slate-900 border border-border shadow-sm flex flex-col items-center justify-center text-primary font-bold text-[10px] uppercase tracking-widest">
