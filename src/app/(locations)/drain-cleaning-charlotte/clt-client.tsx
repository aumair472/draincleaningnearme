      ...
      <main className="flex-1 pt-20">
            ...
            <div className="flex flex-col items-center text-center container-narrow">
              ...
              >
                <div className="flex -space-x-1.5">
                   {[1,2,3].map(i => <div key={i} className="w-5 h-5 rounded-full border-2 border-card bg-primary/20 flex items-center justify-center text-[8px] font-bold">NC</div>)}
                </div>
                <span className="text-sm font-semibold text-text/60 font-black">
                   Licensed and Insured Charlotte Plumbers
                </span>
              </motion.div>
        ...
        <section className="py-24 bg-bg border-b border-border text-center">
          <div className="container">
             ...
             <p className="text-text/70 font-medium text-lg mb-16 italic italic">Serving all of Charlotte from NoDa to Ballantyne.</p>
