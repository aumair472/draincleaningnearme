...
const serviceAreas = [
  ...
  "Washington Park", "Five Points", "Baker"
];

const mainTelLink = "tel:+17247506935";

export function DenverClient() {
      ...
      <main className="flex-1">
        ...
        <section className="relative flex flex-col justify-center pt-24 pb-12 overflow-hidden bg-bg border-b border-border">
          ...
          <div className="container relative z-10 w-full">
            <div className="flex flex-col items-center text-center container-narrow">
              <TrustBadge 
                badgeText="DEN"
                text="Licensed and Insured Denver Plumbers"
              />
              ...
              <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight mb-6 uppercase italic text-text leading-[1.1] animate-fade-in">
                Professional Drain Cleaning & <span className="text-primary italic font-black">Rooter Services</span> in Denver
              </h1>
              ...
              <div className="text-base md:text-lg text-text/70 font-medium max-w-3xl mx-auto mb-8 italic leading-relaxed animate-fade-in [animation-delay:100ms]">
                Clogged drains causing issues in the Mile High City? We deliver fast, reliable services Denver residents trust for hydro jetting, sewer cleaning and emergency fixes.
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-6 py-4 px-8 bg-card/50 border border-border rounded-full text-sm font-semibold text-text/60 animate-fade-in [animation-delay:300ms]">
                 ...
                 <div className="flex items-center gap-2"><Star size={18} className="text-accent fill-accent" /> Denver Experts</div>
              </div>
            </div>
          </div>
        </section>

        {/* 2. WHY DENVER NEEDS EXPERT HELP (LOCAL AUTHORITY) */}
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text leading-tight">
                   Why Denver Homes Need Expert Drain Cleaning
                </h2>
                <div className="text-lg text-text/70 leading-relaxed font-medium space-y-6">
                   <p>
                    Denver's unique combination of high elevation and a semi-arid climate creates specific plumbing challenges. Fluctuating water pressure driven by altitude can stress older plumbing systems, while our natural mineral-rich water leads to significant scale buildup in pipes over time.
                   </p>
                   <p>
                    Rapid freeze-thaw cycles in the Front Range shift the soil, often causing subterranean cracks in older clay or cast-iron sewer lines common in historic neighborhoods like Capitol Hill and Highlands. These cracks become entry points for aggressive tree roots seeking moisture in the dry Denver soil.
                   </p>
                </div>
                <div className="p-8 rounded-[2rem] bg-bg border border-border shadow-inner relative overflow-hidden group">
                   <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:scale-110 transition-transform"><Mountain size={60} /></div>
                   <h3 className="text-xl font-bold text-text mb-4 tracking-tight uppercase">High-Altitude Specialization</h3>
                   <p className="text-sm text-text/50 italic leading-relaxed">
                      "We specialize in resolving altitude-related pressure issues and mineral scale buildup that are common in Denver's residential plumbing infrastructure."
                   </p>
                </div>
              </div>
              <div className="relative">
                 <div className="aspect-square bg-bg border border-border rounded-[3.5rem] p-8 md:p-10 shadow-2xl relative overflow-hidden flex flex-col justify-center items-center text-center">
                    ...
                    <h3 className="text-2xl font-bold text-text mb-4 tracking-tight">Mile High Plumbing Experts</h3>
                    <p className="text-sm text-text/50 font-semibold max-w-xs leading-relaxed uppercase tracking-widest">
                       Specialists in Front Range soil shifts and high-altitude mineral descaling.
                    </p>
                    <div className="mt-8">
                       <p className="text-xs font-bold text-primary uppercase tracking-widest bg-primary/5 px-4 py-2 rounded-full border border-primary/20">
                          Resilient Plumbing for Denver Altitude
                       </p>
                    </div>
                 </div>
              </div>
          ...
          <div className="container">
             <div className="text-center mb-12 space-y-3">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text">
                  Our Drain Cleaning Services in Denver
                </h2>
                <p className="text-text/70 font-medium text-lg max-w-2xl mx-auto italic">
                    Comprehensive solutions customized to Denver local needs. From snaking to high-pressure jetting.
                </p>
             </div>

             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { title: "Rooter Services Denver", desc: "Mechanical snaking to break up hair and food clogs in Highlands kitchen and bathroom lines.", icon: Hammer },
                  { title: "Hydro Jetting Services", desc: "Eco-friendly, chemical-free 4,000 PSI water blasting to clear decade-old scale and roots from Denver sewers.", icon: Waves },
                  { title: "Sewer Line Cleaning", desc: "Tackling tree root intrusion common in establish neighborhoods with mature canopies like Wash Park.", icon: Droplets },
                  { title: "Emergency Drain Service", desc: "24/7 rapid response for backups arriving within 60 minutes across the Denver metro area.", icon: Zap },
                  { title: "HD Camera Inspection", desc: "Pinpointing altitude-related pipe stress or hidden root damage in LoDo and Capitol Hill properties.", icon: Search },
                  { title: "Pipe Descaling", desc: "Specific treatment to remove heavy mineral buildup caused by Denver's hard water content.", icon: Building2 }
                ].map((s, i) => (
           ...
           <div className="container">
              <div className="text-center mb-12 space-y-3">
                 <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text leading-tight max-w-4xl mx-auto uppercase">
                    Common Drain Problems in Denver
                 </h2>
                 <p className="text-lg text-text/70 font-medium max-w-3xl mx-auto italic">
                    Denver's altitude and soil conditions create unique plumbing headaches.
                 </p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                 {[
                   { t: "Hard Water Mineral Scale", d: "Calcium and magnesium buildup narrows Front Range pipes over time, causing chronic slow drains.", icon: Activity },
                   { t: "Altitude Pressure Stress", d: "High elevation water pressure fluctuations can weaken and crack historic plumbing joints.", icon: Utensils },
                   { t: "Freeze-Thaw Soil Shift", d: "Rapid temperature swings move the ground, causing subterranean sewer line misalignments.", icon: Droplets },
                   { t: "Tree Root Entry", d: "Large trees in established neighborhood blocks seek moisture in aging clay pipe connections.", icon: Building2 },
                   { t: "Aging Sewer Infrastructure", d: "Homes built pre-1970 often face significant corrosion of original cast-iron or clay lines.", icon: Waves }
                 ].map((item, i) => (
                 ...
                 <div className="p-8 rounded-[2rem] bg-slate-900 border border-border flex flex-col justify-center items-center text-center space-y-4 text-white">
                    ...
                    <h3 className="text-xl font-bold tracking-tight">Stop foundation damage!</h3>
                    <p className="text-xs text-white/40 font-bold uppercase tracking-widest leading-relaxed">
                       Sewer line leaks into Denver's clay soil can cause massive foundation settling costs.
                    </p>
                 </div>
              </div>
           </div>
        ...
        <section className="py-14 md:py-16 bg-bg border-b border-border">
           <div className="container-narrow text-center space-y-16">
              ...
              <p className="text-lg text-text/70 font-medium italic">Do not ignore early warnings; acting fast saves thousands on drain repair in Denver:</p>
              <div className="grid sm:grid-cols-2 gap-4 text-left">
                 {[
                   "Slow drains throughout the Mile High City home",
                   "White scale buildup on fixtures signaling hard water",
                   "Occasional gurgling sounds from your pipes",
                   "Sewage smells or foul odors near drain openings",
        ...
        <section className="py-24 bg-card border-y border-border">
           <div className="container">
              <div className="text-center mb-12 space-y-3">
                 ...
                 <p className="text-text/70 font-medium text-lg max-w-2xl mx-auto italic">Transparent, efficient service for Denver homes.</p>
              </div>
              <div className="grid md:grid-cols-5 gap-8">
                 {[
                   { t: "Inspection", d: "High-resolution camera scope for buried line issues.", icon: Search },
                   { t: "Diagnosis", d: "Pinpoint cause: scale, roots, or soil shift damage.", icon: Activity },
                   { t: "Method selection", d: "Snaking for minor clogs; hydro jetting for Denver scale.", icon: Hammer },
                   { t: "Execution", d: "Non-invasive cleaning of full drainage and sewer lines.", icon: CheckCircle2 },
                   { t: "Final testing", d: "Confirm flow capacity and verify zero drainage delay.", icon: Waves }
                 ].map((s, i) => (
          ...
          <div className="container text-center">
             ...
             <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {[
                  ...
                  { t: "Upfront Denver Pricing", icon: Search },
             ...
             <p className="mt-12 text-sm text-text/60 font-medium italic">5-star service from Cherry Creek to Highlands.</p>
          </div>
        </section>

        {/* 8. PREVENTION TIPS (DENVER DATA) */}
        <section className="py-14 md:py-16 bg-card border-b border-border">
           <div className="container-narrow space-y-16 text-center">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text leading-tight">
                Prevention Tips for Denver Drains
              </h2>
              <p className="text-lg text-text/70 font-medium italic max-w-2xl mx-auto">Protect your Front Range property with these data-backed maintenance tips:</p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                 {[
                   { t: "Monitor water pressure", icon: Trash2 },
                   { t: "Install water softener", icon: Hammer },
                   { t: "Annual inspections", icon: Search },
                   { t: "Avoid grease in sink", icon: ShieldAlert }
                 ].map((tip, i) => (
        ...
        <section className="py-14 md:py-16 bg-bg border-b border-border">
          <div className="container text-center">
             ...
             <p className="text-text/70 font-medium text-lg mb-10 italic">Covering all Denver neighborhoods with localized high-altitude plumbing expertise.</p>
        ...
        <section className="py-14 md:py-16 bg-card border-b border-border">
           <div className="container-narrow">
              ...
              <div className="space-y-4">
                {[
                  { q: "How much does drain cleaning cost in Denver?", a: "Standard residential drain unclogging in Denver typically ranges from $150 to $350. Major main line descaling or root removal may vary, which is why we offer free upfront estimates." },
                  { q: "How often should Denver homeowners have drains inspected?", a: "Due to hard water scale and deep-root trees in our neighborhoods, we recommend a professional camera inspection and cleaning every 12 to 18 months." },
                  { q: "Is hydro jetting safe for older Capitol Hill homes?", a: "Yes. When performed by trained professionals like us, hydro jetting is the safest and most effective way to clear clay and cast-iron lines of decades of scale and roots." },
                  { q: "Why do my drains gurgle during a rapid weather shift?", a: "Front Range pressure changes and ground shifts can impact your vent stack and sewer flow. Gurgling is often an early sign of a partial mainline blockage." },
                  { q: "Do you offer 24/7 service in Five Points?", a: "Yes, we are Denver's full-service, 24/7 emergency response team for all drain and sewer line disasters city-wide." }
                ].map((faq, index) => (
        ...
        <section className="py-24 bg-bg overflow-hidden relative border-y border-border">
           ...
           <div className="container-narrow text-center space-y-8 relative z-10">
              ...
              <p className="text-xl text-text/60 font-medium max-w-2xl mx-auto italic">
                 Licensed professionals ready 24/7. Same-day drain cleaning across Denver.
              </p>
              ...
              <p className="text-xs font-bold text-text/30 tracking-widest uppercase">
                 Local Denver Drain Experts &middot; Licensed, Insured, Guaranteed.
              </p>
           </div>
        </section>
