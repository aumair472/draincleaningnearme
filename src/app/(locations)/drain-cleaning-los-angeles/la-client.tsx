      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-[80vh] flex flex-col justify-center py-20 overflow-hidden bg-bg border-b border-border">
          ...
          <div className="container relative z-10 w-full">
            <div className="flex flex-col items-center text-center container-narrow">
              <TrustBadge 
                badgeText="LA"
                text="Licensed and bonded Los Angeles plumbers"
              />
                ...
                <div className="grid gap-6">
                   {[
                     ...
                     { t: "High water usage in dense areas", d: "Continuous strain on plumbing in Downtown LA and apartment complexes." }
                      ...
                      <div key={i} className="flex gap-4 p-4 rounded-2xl bg-bg border border-border hover:border-primary/20 transition-all shadow-sm group">
             ...
             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={i} className="p-8 rounded-[2rem] bg-card border border-border hover:border-primary/20 transition-all hover:shadow-2xl group flex flex-col items-center text-center shadow-sm animate-fade-in-up" style={{ animationDelay: `${i * 100}ms` }}>
                    <div className="w-16 h-16 rounded-2xl bg-primary/5 text-primary flex items-center justify-center mb-6 transition-colors group-hover:bg-primary group-hover:text-white shadow-inner">
                       <s.icon size={32} />
                    </div>
          ...
          <div className="container">
             <div className="grid lg:grid-cols-2 gap-10 items-center">
                <div className="relative order-2 lg:order-1">
                   <div className="p-10 bg-bg border border-border rounded-[3rem] shadow-2xl space-y-6 relative overflow-hidden">
                ...
                <div className="space-y-6 order-1 lg:order-2">
                   <h2 className="text-3xl md:text-5 font-bold tracking-tight text-text leading-tight">
          ...
          <div className="container">
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
                {[
                  ...
                  <div key={i} className="p-4 rounded-2xl bg-bg border border-border flex flex-col items-center text-center space-y-4 group hover:border-primary/20 transition-all shadow-sm">
        ...
        <section className="py-14 md:py-16 bg-card border-b border-border">
          <div className="container text-center">
             ...
             <p className="text-text/70 font-medium text-lg mb-10 italic">Fast local response from Downtown to the Valley.</p>
             <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
               {neighborhoods.map(n => (
                 <div key={n} className="p-4 rounded-2xl bg-bg border border-border shadow-sm flex items-center gap-4 group hover:border-primary/30 transition-all">
              ...
              <div className="p-12 md:p-20 rounded-[4rem] bg-slate-900 border border-primary/20 text-white text-center shadow-2xl relative overflow-hidden group">
                  <div className="relative z-10 space-y-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                       <a
                          href={mainTelLink}
                          className="w-full sm:w-auto flex items-center justify-center gap-4 px-10 py-5 bg-white text-primary rounded-2xl font-bold text-2xl shadow-xl hover:bg-slate-50 hover:-translate-y-1 transition-all active:scale-95 group tracking-tight"
                       >
                       ...
                       <a
                          href={mainTelLink}
                          className="w-full sm:w-auto flex items-center justify-center gap-4 px-10 py-5 bg-white/10 text-white border-2 border-white/20 rounded-2xl font-bold text-2xl hover:bg-white hover:text-primary transition-all active:scale-95 tracking-tight"
                       >
                          Get free estimate
                       </a>
                    </div>
