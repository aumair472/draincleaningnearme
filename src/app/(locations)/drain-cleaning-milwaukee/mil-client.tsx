...
const serviceAreas = [
  "Historic Third Ward", "Bay View", "Riverwest", "East Side", 
  "Walker's Point", "Wauwatosa", "West Allis"
];

const mainTelLink = "tel:+17247506935";

export function MILClient() {
      ...
      <main className="flex-1 pt-20">
            ...
            <div className="flex flex-col items-center text-center container-narrow">
              ...
              >
                <div className="flex -space-x-1.5">
                   {[1,2,3].map(i => <div key={i} className="w-5 h-5 rounded-full border-2 border-card bg-primary/20 flex items-center justify-center text-[8px] font-bold">MIL</div>)}
                </div>
                <span className="text-sm font-semibold text-text/60 font-black">
                   Licensed and Insured Milwaukee Plumbers
                </span>
              </motion.div>
              ...
              >
                Professional Drain Cleaning & <span className="text-primary italic">Rooter Services</span> in Milwaukee
              </motion.h1>
              ...
              >
                Clogged drains disrupting your Milwaukee home or business? We deliver fast, reliable solutions for specialized plumbing challenges, from historic East Side pipes to modern sewer line clearing.
              </motion.div>
              ...
              >
                 ...
                 <div className="flex items-center gap-2"><Star size={18} className="text-accent fill-accent" /> Milwaukee Experts</div>
              </motion.div>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text leading-tight uppercase font-black underline decoration-primary decoration-4 underline-offset-8">
                   Milwaukee's Historic & Winter Challenges
                </h2>
                <div className="text-lg text-text/70 leading-relaxed font-medium space-y-6 italic">
                   <p>
                    Milwaukee's infrastructure, from the Historic Third Ward to Bay View, relies on aging systems that face extreme seasonal stress. Harsh Wisconsin winters and freezing temperatures often lead to pipe contraction and underground shifts.
                   </p>
                   <p>
                    Older cast iron and clay pipes are particularly vulnerable to offsets and tree root intrusion, requiring professional hydro jetting and HD camera inspections to restore full capacity.
                   </p>
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
                   {[
                     { t: "Historic Pipe Decay", d: "Old iron and clay systems prone to collapse.", icon: Activity },
                     { t: "Freezing Ground", d: "Winter shifts cause pipe misalignments.", icon: ThermometerSnowflake },
                     { t: "Tree Root Intrusion", d: "Aggressive roots invade old sewer line joints.", icon: Droplets },
                     { t: "Grease & Sludge", d: "Common in high-density multi-unit buildings.", icon: Utensils }
                   ].map((item, i) => (
              ...
              <div className="relative">
                 <div className="aspect-square bg-bg border border-border rounded-[3rem] p-12 shadow-2xl relative overflow-hidden flex flex-col justify-center items-center text-center">
                    ...
                    <p className="text-sm text-text/50 font-bold max-w-xs leading-relaxed uppercase tracking-widest italic">
                       Delivering 5-star service from Riverwest to Walker's Point.
                    </p>
                 </div>
              </div>
            </div>
          ...
          <div className="container text-center">
             <div className="mb-20 space-y-4">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-text uppercase font-black">
                  Milwaukee Drain Services
                </h2>
                <p className="text-text/70 font-medium text-lg max-w-2xl mx-auto italic">
                    Fast relief from backups, slow drains and foul odors in Milwaukee County.
                </p>
             </div>
             ...
             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  { title: "Commercial Drain Solutions", desc: "Heavy-duty grease trap and line cleaning for Milwaukee's restaurant scene.", icon: Building2 },
        ...
        <section className="py-24 bg-card border-b border-border text-center">
          <div className="container">
             ...
             <p className="text-text/70 font-medium text-lg mb-16 italic">Serving all of Milwaukee and surrounding areas.</p>
        ...
        <section className="py-24 bg-bg border-b border-border">
           <div className="container-narrow">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-center text-text mb-20 uppercase font-black uppercase italic underline decoration-primary decoration-4 underline-offset-8">
                Milwaukee Drain FAQs
              </h2>
              <div className="space-y-4 font-black uppercase italic">
                {[
                  { q: "How much does drain cleaning cost in Milwaukee?", a: "Residential drain clearing typically ranges from $150 to $450 depending on the severity and equipment needed. We provide upfront quotes on-site." },
                  { q: "Can old Milwaukee pipes handle hydro jetting?", a: "Yes, but we always perform an HD camera inspection first to verify the pipe's integrity before applying high pressure." },
                  { q: "Do you offer emergency services in Bay View?", a: "Absolutely. We offer 24/7 priority response for Bay View and all surrounding Milwaukee neighborhoods." },
                  { q: "Why are my drains slow in the winter?", a: "Freezing temperatures can cause trap issues or venting problems. Our experts can diagnose and fix this fast." }
                ].map((faq, index) => (
