      ...
      <main className="flex-1">
        ...
        <section className="relative flex flex-col justify-center pt-24 pb-12 overflow-hidden bg-bg border-b border-border">
          ...
          <div className="container relative z-10 w-full">
            <div className="flex flex-col items-center text-center container-narrow">
              ...
              <div className="flex flex-wrap justify-center gap-6 py-4 px-8 bg-card/50 border border-border rounded-full text-sm font-semibold text-text/60 uppercase tracking-widest animate-fade-in [animation-delay:300ms]">
          ...
          <div className="container text-center">
             ...
             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={i} className="p-8 rounded-[2rem] bg-card border border-border hover:border-primary/20 transition-all group flex flex-col items-center text-center shadow-sm animate-fade-in-up" style={{ animationDelay: `${i * 100}ms` }}>
        ...
        <section className="py-14 md:py-16 bg-card border-b border-border">
           <div className="container">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 text-center uppercase tracking-tight font-black">
                 {[
                 ...
                 <div className="p-8 rounded-[2rem] bg-slate-900 border border-border flex flex-col justify-center items-center text-center space-y-4 text-white uppercase italic">
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-left">
                 {[
                   ...
                   "Foul odors and gurgling in pipes"
                    ...
                    <div key={i} className="flex items-center gap-4 p-4 rounded-2xl bg-card border border-border shadow-sm group hover:border-primary/20 transition-all font-bold text-text tracking-tight uppercase leading-tight text-sm font-black">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                 {[
                   ...
                   { t: "Industrial Hydro Jetting", d: "Heavy-duty fixes for large-scale lines.", icon: Waves }
                    ...
                    <div key={i} className="p-8 rounded-[2rem] bg-bg border border-border shadow-sm flex flex-col items-center gap-6 italic group">
        ...
        <section className="py-24 bg-bg border-b border-border text-center">
          <div className="container">
             ...
             <p className="text-text/70 font-medium text-lg mb-10 italic italic">Across Santa Clara valley with 60-minute dispatch.</p>
