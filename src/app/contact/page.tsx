...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://draincleaningnearme.us/contact",
  },
  robots: {
    index: true,
    follow: true,
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-bg">
        ...
        <div className="container relative z-10">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight mb-8 text-text leading-tight animate-fade-in-up">
              Get Immediate Drain Cleaning Help Near You – <span className="text-primary italic">Call Now!</span>
            </h1>
            <p className="text-lg md:text-xl text-text/80 font-medium mb-12 leading-relaxed max-w-3xl animate-fade-in-up [animation-delay:200ms]">
